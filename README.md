...
| 2025.03.17 <br>~ <br> 2025.03.25    |   [Web Archive](https://github.com/jungwoo0601/IMWA-WebArchieve)                                | Web Archive   | FE PL  | HTML, CSS, JS
| 2024.05.12 <br>~ <br> 2024.08.20 (리팩토링 중)      |   [SUCAT](https://github.com/jungwoo0601/Sucat)                                | 게임, 친구/채팅을 접목시킨 친목형 대학교 커뮤니티 웹서비스   | FE 팀장  | Html, Css, JavaScript, React <br> Web Socket, WebClient, <br>AWS(EC2, RDS, S3, Route 53, ELB ...)                                                            |
| 2024.05.10 <br>~ <br> 2024.09.02 (리팩토링 중)      | [스스Law](https://github.com/jungwoo0601/SSL-AI)                                           | 법률 문제를 스스로 해결할 수 있도록 도움을 제공하는 법률 상담 챗봇 웹서비스     | FE 팀장, <br> AI/SW 공모전 참가하여 우수상 수상  | Html, Css, JavaScript, React, WebSocket <br>AWS(EC2, RDS, ELB, DNS, IAM)                              |
